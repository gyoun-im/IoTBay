    ...
    <body>
        ...
        <table style="border: 0px solid #ddd; border-collapse: collapse; border-color: black; margin-left: 250px;" cellspacing="120"> 
            ...
            <tr style="border: 0px">
                ...
                <td style="border-bottom: 0px solid #ddd; border-color:gray; color:black; padding:10px;"><%=shipmentList.getShipmentID()%> </td>
                <td style="border-bottom: 0px solid #ddd; border-color:gray; color:black; padding:10px;"><%=shipmentList.getCourierName()%> </td>
                <td style="border-bottom: 0px solid #ddd; border-color:gray; color:black; padding:10px;"> <%=shipmentList.getShipmentStatus()%></td>
        ...
        <%  } else {%> 
        <div style="margin-left:auto; margin-right:auto"> <img src="css/notfound.png" style="margin-left:auto; margin-right:auto; text-align:center" height="45px" width-="45px;" class="centera"> </div>
        <h1 style="color:tomato; text-align:center; margin-left:250px;"> <%= (shipmentErr != null ? shipmentErr : "")%>   </h1>
        <p style="text-align:center"> If you think that it is incorrect, or you have any ongoing shipments, please contact our IoTBay customer service <a href==#" style="color:tomato">here</a> so we could assist you right away. You may also wait a few days to see if you shipment have been dispatched after date of purchase. </p>
        <%}%>
