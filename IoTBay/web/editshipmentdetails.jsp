...
<html>
    <head>
        ...
        <% User_Account user = (User_Account) session.getAttribute("user");
            ...
            Shipment_Details shipmentD = (Shipment_Details) session.getAttribute("shipmentDet");
    ...
    <body>
        ...
        <h1 style="color:tomato; text-align:left; margin-left:20px;display:inline-block;font-size: 25px; color: black;"> Edit Shipment Details: &nbsp; &nbsp;  <div style="color:green; float:right;" class="shakeanimation"> <%= (updated != null ? updated : "")%> </div> <div style="color:tomato; float:right;" class="shakeanimation"><%= (postcodeErr != null ? postcodeErr : "")%></div> <div style="color:tomato; float:right;" class="shakeanimation"> <%= (addressErr != null ? addressErr : "")%></div></h1>
        <form action="UpdateShipmentDetailsServlet?shipmentDetailsID=<%=shipmentD.getShipmentDetailsID()%>" method="post">
            ...
            <table style="border-bottom:1px; border-left:0px; border-right:0px; border-top:0px; border-left:0px; padding:3.8px; margin-left:300px;">
                ...
                <tr><td><input type="text" class="no-outline" name="streetAddress" placeholder="Street Address Name" value="<%=shipmentD.getStreetAddress()%>" required></td></tr>
                <tr><td>Suburb</td></tr>
                <tr><td><input type="text" class="no-outline" name="suburb" placeholder="Suburub Name"  value="<%=shipmentD.getSuburb()%>"required></td></tr>
                <tr><td>Postcode</td></tr>
                <tr><td><input type="int" class="no-outline" name="postcode" placeholder="Postcode" value="<%=shipmentD.getPostcode()%>" required></td></tr>

                <tr><td><label for="states"> State </state></td></tr>
                <tr><td><select id="state" name="state" value="<%=shipmentD.getState()%>">
                            <option> NSW </option>
                            <option> VIC </option>
                            <option> TAS </option>
                            <option> WA </option>
