...
<html>
    ...
    <body>
        ...
        <h1 style="color:tomato; text-align:left; margin-left:20px;display:inline-block;font-size: 25px; color: black;"> Edit Shipment Details: &nbsp; &nbsp;  <div style="color:green; float:right;" class="shakeanimation"> <%= (updated != null ? updated : "")%> </div></h1>
        <form action="UpdateShipmentDetailsServlet?shipmentDetailsID=<%=shipmentD.getShipmentDetailsID()%>" method="post">
            <!-- So, "addShipmentDetailsServlet?userID= (JSP TAG) ser.getId() (JSP TAG) -->
            ...
            <br><br>
            <a href="ShipmentDetailsServlet?&userID=3"><button class="button3" type="button" style="margin-left:95px;"> <b>CANCEL</b> </button></a>
            <!-- So, "addShipmentDetailsServlet?userID= (JSP TAG) ser.getId() (JSP TAG) -->
