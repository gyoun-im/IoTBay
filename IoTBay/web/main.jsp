    ...
    <body>
        ...
        <%  if (user!=null) { %>
         ...
         <table cellspacing="0" cellpadding="0" width="100%">
                            ...
                            <th class="dropdown">  <img src="css/user.png" width="25px" height="25px">&nbsp; &nbsp; &nbsp;Hi, ${user.name}! <div class="dropdown-content"><a href="ShipmentDetailsServlet?userID=7" style="color:black;"> Shipment Details </a>
