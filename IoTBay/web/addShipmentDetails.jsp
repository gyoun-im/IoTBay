...
<html>
    ...
    <body>
        ...
        <h1 style="color:tomato; text-align:left; margin-left:20px;display:inline-block;font-size: 25px; color: black;"> Add Shipment Details: &nbsp; &nbsp;  <div style="color:tomato; float:right;" class="shakeanimation"> <%= (postcodeErr != null ? postcodeErr : "")%> </div></h1>
        <form action="addShipmentDetailsServlet?userID=3" method="post">
            ...
            <table style="border-bottom:1px; border-left:0px; border-right:0px; border-top:0px; border-left:0px; padding:3.8px; margin-left:300px;">
                ...
                <tr><td>Suburb</td></tr>
                <tr><td><input type="text" class="no-outline" name="suburb" placeholder="Suburub Name" required></td></tr>
